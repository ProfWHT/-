              ...
              <div className="lg:col-span-7 space-y-6">
                <div className="bg-white p-6 md:p-8 rounded-2xl border border-slate-200 shadow-sm relative overflow-hidden">
                  ...
                  <p className="text-slate-700 leading-relaxed mb-6">
                    তাহফিজুল কুরআন মডেল মাদ্রাসার একটি স্থায়ী দ্বীনি মজবুত ভিত্তি স্থাপনে আমাদের চিরস্থায়ী ক্যাম্পাস নির্মাণ প্রকল্প হাতে নেওয়া হয়েছে। আপনার প্রদত্ত জমি দান হবে আপনার এবং আপনার পরিবারের জন্য একটি সদকায়ে জারিয়া, যার সওয়াব কিয়ামত পর্যন্ত জারি থাকবে ইন้าআল্লাহ।
                  </p>
