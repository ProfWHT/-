    ...
    <div className="py-20 max-w-7xl mx-auto px-4">
      ...
      <div className="grid md:grid-cols-2 gap-12">
        <div className="prose prose-lg text-gray-700">
           <p>তাফসীরুল কুরআন মাদ্রাসা একটি অত্যাধুনিক ইসলামিক শিক্ষা প্রতিষ্ঠান। মুসলিম নগর, বুড়িরডাঙ্গা, দিগরাজ, মোংলা, বাগেরহাট ঠিকানায় অবস্থিত এই প্রতিষ্ঠানটি দ্বীনি শিক্ষার এক বিশ্বস্ত নাম।</p>
